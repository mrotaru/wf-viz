...
2009–12–22: Release 2.6.0-2.mp
  ...
  • There were some MinGW cross-compilation issues under Linux related with the
    ...
    file “windows.h”. I’ve changed the #include so that the header filename is
    all lowercase.

2009–11–29: Release 2.6.0-1.mp

  • First 2.6.0 MinGW release. I’ve built the package using MinGW, and the only
